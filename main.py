...
kpi_kdr_melee = df_merged[df_merged['RorM']=='Melee']['kills'].sum() / df_merged[df_merged['RorM']=='Melee']['deaths'].sum()
kpi_kdr_ranged = df_merged[df_merged['RorM']=='Ranged']['kills'].sum() / df_merged[df_merged['RorM']=='Ranged']['deaths'].sum()
...
figpie = px.pie(df, values=df['sessionTimeMins'], names=df['RorM'], title='Ranged vs Melee Playtime(Total Minutes)',color='RorM',color_discrete_map={'Ranged':'red',
                                                                                                                               'Melee':'blue'},width=300,height=300)
